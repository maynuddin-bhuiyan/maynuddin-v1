        ...
        <div className="py-10 lg:py-20">
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-14">
                    <div className="relative lg:h-[500px] md:h-[600px] h-[400px]">
                        {/* Shapes */}
                        ...
                        <div className="absolute top-0 left-0">
                            <Image
                                ...
                                height={300}
                            />
                            <div className="absolute md:-bottom-28 -bottom-20 right-20">
                        ...
                        <div className="absolute top-3 left-[260px]">
                            <Image
                                src="/about-2.png"
                                alt="Image 2"
                        ...
                        <div className="absolute md:bottom-5 left-[200px] bottom-0">
                            <Image
                                src="/about-1.png"
                                alt="Image 3"
                    ...
                    <div className="flex flex-col justify-center">
                        <h3 className="lg:text-lg font-medium text-indigo-500 lg:mb-2">About us</h3>
                        <h2 className="lg:text-4xl text-lg font-bold text-gradient mb-5"> Creating A Community Of Life Long Learners</h2>

                        <p className="text-gray-300">
                            Without some form of active processing, like teaching, almost everything we read is lost. Sed metus lectus, placerat ac vitae, pharetra ut metus.
                        </p>
                            ...
                            <div className="flex items-center gap-3 my-5">
                                ...
                                <p className="text-gray-300 text-sm md:text-base">
                                    Call for Quality Services: 005-222-2520
                                </p>
