        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-14">
          <div className="relative lg:h-[430px] md:h-[450px] h-[300px]">
            ...
            <div className="absolute -top-6 -left-5">
              ...
              >
                <path
                  d="M72 3.00001C72 1.34315 70.6562 -0.00652 69.0008 0.062495C60.5695 0.414 52.2575 2.2454 44.4468 5.48067C35.7114 9.09901 27.7741 14.4025 21.0883 21.0883C14.4025 27.7741 9.09901 35.7113 5.48068 44.4468C2.24539 52.2574 0.413999 60.5695 0.0624817 69.0008C-0.00653385 70.6562 1.34314 72 3 72L69 72C70.6568 72 72 70.6569 72 69L72 3.00001Z"
                  fill="#1B38DF"
                />
              </svg>
            </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="lg:text-4xl text-lg font-bold text-gradient mb-5">
              {" "}
              I specialize in website and web application development.
            </h2>

            <p className="text-gray-300">
              Responsible for front-end development with expertise in React JS
              and Next.js.
            </p>
            <p className="!text-[#ffffff] font-normal lg:mt-2 text-sm lg:text-base">
              I’m excited to share that I designed and built my own website
              using a mix of HTML, CSS, JavaScript, Next.js, ES6, SCSS, and
              Redux! I also have experience with Tailwind CSS, which reflects my
              passion for creating engaging and user-friendly web experiences.
              It’s been a great journey, and I love bringing ideas to life
              online!
            </p>
            ...
            <Link
              target="_blank"
              href={"https://calendly.com/maynuddinbhu14grm/30min"}
