...
export default function Footer() {
  const iconsData = [
    // { id: 1, icon: <TbFileCv size={20} />, href: "https://drive.google.com/file/d/1WqIVuShqUjqD2_8y9zd_N7_jJB1CbF1J/view?usp=sharing" },
    {
      ...
      href: "https://github.com/maynuddin-bhuiyan",
    },
    {
      id: 4,
      ...
      <div className="container">
        <div className="lg:flex lg:justify-between items-center">
          <div className="flex flex-col">
            <h2 className="text-black text-2xl font-bold text-gradient space-grotesk">
              Maynuddin
            </h2>
            ...
            <Link
              ...
              href="mailto:hellomaynuddin@gmail.com"
            >
              hellomaynuddin@gmail.com
            </Link>
          </div>
          <nav className="flex space-x-6 lg:my-0 my-1">
